...
class Sourd:
    ...
    # def dp_bounded(self, n, bound, idle_bound): # not a correct way
    ...
    #             for t in self.vs[n]:
    #                 if t < bound:
    #                     obj = self.et(n, t) + self.dp_bounded(n - 1,
    #                                                           t - self.problem.processing_times[
    #                                                               self.jobs[n]], idle_bound - 1) + self.problem.b
    #                     if obj < best_obj:
    #                         best_obj = obj
    ...
    #         if n == len(self.jobs) - 1:
    #             for t in self.vs[n]:
    #                 obj = self.et(n, t) + self.dp_bounded(n - 1, t - self.problem.processing_times[self.jobs[n]], 0)
    #                 if obj < best_obj:
    #                     best_obj = obj
    #         elif n == 0:
    #             best_obj = self.et(n, bound)
    ...
    def run_bounded(self):
        self.init_variable_space()
        self.init_memo()
        return self.dp_bounded_1(self.problem.n - 1, -1, self.idle_bound)
